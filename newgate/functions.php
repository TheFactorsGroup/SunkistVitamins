...
define('CMSMS_CUSTOMIZER', CMSMS_ADMIN . '/customizer');
...
require_once(CMSMS_CUSTOMIZER . '/cmsms-theme-customizer.php');
...
function cmsms_google_fonts_list() {
	$fonts = array( 
		...
		'Raleway:400,900,700,200' => 'Raleway', 
...
add_action( 'wp_enqueue_scripts', 'factors_saas_scripts' );